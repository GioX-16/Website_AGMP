...
const team = [
    ...
    {
        name: "Fajardo Lamelas",
        role: "Ingeniero de Sistemas",
        img: "/images/Team/faj.svg",
        linkedin: "https://www.linkedin.com/in/carlos-francisco-fajardo-lamelas-32755538a/",
        instagram: "https://www.instagram.com/carlosfajardo._?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==",
        whatsapp: "+505 8182 4550"
    },
    {
    ...
    {
        name: "Alondra Zeledón",
        role: "Ingeniera en Economía",
        img: "/images/Team/Alondra.svg",
        linkedin: "https://www.linkedin.com/in/alondra-zeledon/",
        instagram: "https://www.instagram.com/zeledxn/",
        whatsapp: "+505 8738 3915"
    }
];
                    ...
                    {team.map((member, index) => (
                        ...
                        >
                            ...
                            <div className="flex justify-center space-x-2 sm:space-x-3 mb-3">
                                ...
                                {/* GitHub para algunos, Instagram para Sofia y Anielka */}
                                {member.name === "Sofia Barrios" || member.name === "Anielka Lezama" || member.name === "Alondra Zeledón" || member.name === "Fajardo Lamelas" ? (
                                    <a
